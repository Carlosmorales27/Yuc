...
$sql = "SELECT latitud, longitud FROM hospitales where latitud != 0 and longitud != 0 ";  
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $locations_hospitales[] = array('lat' => $row['latitud'], 'lng' => $row['longitud']);
    }
} else {
    echo "0 resultados";
}
...
<script>
    ...
    var locations = <?php echo json_encode($locations_hospitales); ?>;
