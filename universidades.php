...
$sql = "SELECT Latitud, Longitud FROM educacion_superior where Latitud != 0 and Longitud != 0 ";  
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $locations_universidades[] = array('lat' => $row['Latitud'], 'lng' => $row['Longitud']);
    }
} else {
    echo "0 resultados";
}
...
<script>
    ...
    var locations = <?php echo json_encode($locations_universidades); ?>;
