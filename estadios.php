...
$sql = "SELECT latitud, longitud FROM estadios where latitud != 0 and longitud != 0 ";  
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $locations_estadios[] = array('lat' => $row['latitud'], 'lng' => $row['longitud']);
    }
} else {
    echo "0 resultados";
}
...
<script>
    ...
    var locations = <?php echo json_encode($locations_estadios); ?>;
