...
$sql = "SELECT Latitud, Longitud FROM primarias where Latitud != 0 and Longitud != 0 ";  
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $locations_primarias[] = array('lat' => $row['Latitud'], 'lng' => $row['Longitud']);
    }
} else {
    echo "0 resultados";
}
...
<script>
    ...
    var locations = <?php echo json_encode($locations_primarias); ?>;
